...
// router.get('/getprojects',authenticateUser, authorizeRoles(['Operator', 'SuperAdmin']), getAllProjects); // GET /api/projects

// // Fetch a project by ID
// router.get('/:id',authenticateUser, authorizeRoles(['Operator', 'SuperAdmin']), getProjectById); // GET /api/projects/:id
...
// router.put('/:id',authenticateUser, authorizeRoles(['Operator', 'SuperAdmin']), updateProjectData); // POST /api/projects/data
