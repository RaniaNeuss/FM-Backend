...
// function HTTPclient(data, logger, events, runtime) {
//     var runtime = runtime;
//     var data = data;                   // Current webapi data
//     var logger = logger;               // Logger var working = false;                // Working flag to manage overloading polling and connection
//     var working = false;                // Working flag to manage overloading polling and connection
//     var connected = false;              // Connected flag
//     var events = events;               // Events to commit change to runtime
...
//                 if (result) {
//                     let varsValueChanged = await updateVarsValue(result);
//                     lastTimestampValue = new Date().getTime();
//                     emitValues(varsValue);
...
//                 checkWorking(false);
//             } catch (reason){
//                 logger.error(`'${data.name}' readRequest error! ${reason}`);
//                 checkWorking(false);
//             };
//         } else {
//             emitStatus('connect-busy');
//         }
//     }
...
//                 value = parseValue(data.tags[tagId].type, value);
...
//      * Emit to clients
//      */
//     const clearVarsValue = (varsValue) => {
//         for (const id in varsValue) {
//             varsValue[id].value = null;
//         }
//         emitValues(varsValue); // Ensure emitValues is defined and accessible
//     };
...
//      * @param {*} reqdata
//      */
//     var updateVarsValue = async (reqdata) => {
...
//      * @param {*} status
//      */
//     var emitStatus = function (status) {
//         lastStatus = status;
...
//      * @param {*} values
//      */
//     var emitValues = function (values) {
...
//      * @param {*} check
//      */
//     var checkWorking = function (check) {
//         if (check && working) {
//             overloading++;
